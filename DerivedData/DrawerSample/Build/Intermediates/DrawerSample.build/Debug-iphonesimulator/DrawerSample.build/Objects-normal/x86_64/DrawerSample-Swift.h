...
+ (CGRect)DefaultFrame;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified menuItemContainer;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC12DrawerSample19ViewPagerController")
@interface ViewPagerController : UIViewController <UIPageViewControllerDataSource, UIPageViewControllerDelegate>
@property (nonatomic, weak) IBOutlet UIStackView * _Null_unspecified pagerMenu;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified pageViewContainer;
- (void)viewDidLoad;
- (void)initializeWithControllers:(NSArray<UIViewController *> * _Nonnull)controllers SWIFT_METHOD_FAMILY(none);
